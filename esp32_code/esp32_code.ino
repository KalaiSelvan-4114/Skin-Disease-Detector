...
const String FIREBASE_HOST = "your_firebase_project_id.appspot.com";  // Firebase storage URL
const String FIREBASE_API_KEY = "your_firebase_api_key";              // Your Firebase API Key

// Server settings for prediction endpoint
const String SERVER_URL = "http://your_flask_server_ip:5000/predict"; // Replace with your Flask server IP and port
...
bool uploadToFirebase(camera_fb_t* fb, String &fileLocation) {
  ...
  String firebaseUrl = "https://firebasestorage.googleapis.com/v0/b/" + FIREBASE_HOST + "/o/images%2Fcaptured.jpg?uploadType=media&name=images/captured.jpg&key=" + FIREBASE_API_KEY;
...
// Function to send acknowledgment to server with image location (relative path) and receive prediction
...
void setup() {
  ...
  if (uploadToFirebase(fb, fileLocation)) {
    ...
    // Send acknowledgment to server with file location (relative path) and receive prediction
